...
import 'package:FlutterViz_Flutter_Templates/dialog.dart';
          ...
          child: AppBar(
            title: GestureDetector(
                ...
                onTapUp: (TapUpDetails details) {
                  rootBundle.loadString('assets/codes/Home/HomeScreen1.txt').then((data){
                    showDialog(context: context,builder: (context) => MyDialog("Code",data),);
                  });
